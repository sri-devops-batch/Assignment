...
public class BankWebSite2 {
	...
	public void printAccountDetails(Account a)
	{
		...
		System.out.print(a.getfundTransfer()+"\t");
		System.out.print(a.getDeposit()+"\t");
		System.out.print(a.getwithdrawl()+"\t");
	...
	public void createAccount()
	{
		...
		System.out.println("Enter Account Initial fundTransfer:-");
		int fundTransfer = sc.nextInt();
		
		System.out.println("Enter Account Initial deposit:-");
		int deposit = sc.nextInt();
		
		System.out.println("Enter Account initial withdrawl Ammount");
		int withdrawl = sc.nextInt();
		
		System.out.println("Enter Account initial location");
		String location = sc.nextLine();
		
		allAccounts[noOfAccountEntry++] = new Account(accNumber, accHolderName, balance,fundTransfer,deposit,withdrawl,location);
